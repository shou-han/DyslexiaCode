...
path_temp = 'S:\R-MNHS-SPP\Bellgrove-data\14. Keri Stevens\Study Task Results\EEG_Behav_Data Files\'; %Monash PC
...
Monash_Stationary_EEG = {'KJ1001'}; %Stationary EEG system
...
block_label = {'02','03','04','05','06','07','08','09','10','11','12','13','14','15','16'
    };
    ...
    k=0;
        if ismember(subject_folder{s},Other_System)
            ...
            for n=1:length(block_temp)
                k=k+1;
                files{s}{k} = [path_temp subject_folder{s} '\' allsubj{s}, block_label{n}, '.bdf']
            end
        elseif ismember(subject_folder{s},Monash_Portable_EEG) | ismember(subject_folder{s},Monash_Stationary_EEG)
            ...
            block_temp(find(ismember(block_temp,0))) = [];
                for n=1:length(block_temp)
                    ...
                    files{s}{k} = [allsubj{s},block_label{s},'.vhdr'];
                end
